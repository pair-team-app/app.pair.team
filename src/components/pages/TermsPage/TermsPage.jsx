			...
			<div className="base-page-content-wrapper terms-page-content-wrapper">
				...
				<div>
					...
					<ul>
						...
						<li><h6 className="terms-page-intro-question">Can a Claim be part of a class action or similar proceeding?</h6> No. You agree to resolve your Claims with us solely on an individual basis, and not as part of a class, representative or consolidated action. We agree to do the same.
</li>
