			...
			<div>
				<Row vertical="start">
					<Column flexGrow={1} horizontal="center">
						<Row horizontal="center"><div className="step-header-text">Our Design AI Manifesto</div></Row>
						<div className="manifesto-text">
							...
							<Row><p><img src="/images/intro1.png" className="intro-image" alt="Manifesto" /></p></Row>
