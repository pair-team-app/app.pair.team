			...
			<div className="overlay-container"><Row horizontal="center">
				<div className="overlay-content">
					...
					<Row horizontal="space-between" style={{ flexWrap : 'wrap' }}>
						<Column className="stripe-modal-faq">
							<div className="stripe-modal-faq-title">Will Design Engine be a web app or desktop app?</div>
							<div className="stripe-modal-faq-content"><p>Design Engine is the first design platform built for engineers. From open source projects to enterprise, you can inspect parts, download source, and build interface along worldclass designers.</p></div>
						</Column>
						<Column className="stripe-modal-faq">
							<div className="stripe-modal-faq-title">Will Design Engine be a web app or desktop app?</div>
							<div className="stripe-modal-faq-content"><p>Design Engine is the first design platform built for engineers. From open source projects to enterprise, you can inspect parts, download source, and build interface along worldclass designers.</p></div>
