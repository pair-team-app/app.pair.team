	...
	return (
		<BasePage { ...props } className="privacy-page">
			...
			<div className="base-page-content-wrapper privacy-page-content-wrapper">
				...
				<h5 className="legal">Information You Provide Directly to Us</h5>
				<div>
					<p className="list-title">When you use the Services or engage in certain activities such as creating an Account with Pair, we may ask you to provide some or all of the following types of information:</p>
					<ul>
				...
				<h5 className="legal">Sharing with other Service users</h5>
				<div>
				...
				<h5 className="legal">Information You Submit Through Services</h5>
				<div>
				...
				<h5 className="legal">Information From Other Sources</h5>
				<div>
				...
				<h5 className="legal">Third party websites, social media platforms, and software development kits</h5>
				<div>
				...
				<h5 className="legal">Third Party Payment Processing</h5>
				<div>
				...
				<h5 className="legal">Information we share with Third Parties</h5>
				<div>
					<p>We will not share any Personal Information that we have collected from you except as described below:</p>
				</div>

				<h5 className="legal">Information Shared with Our Services Providers</h5>
				<div>
					<p>We may engage third party service providers to work with us to administer and provide the Services. These third-party services providers have access to your Personal Information for the purpose of performing services on our behalf. The types of service providers (processors) to whom we entrust Personal Information service providers for: <span className="roman-index">i</span> provision of IT and related services; <span className="roman-index">ii</span> provision of information and services you have requested; <span className="roman-index">iii</span> payment processing; <span className="roman-index">iv</span> customer service activities; and <span className="roman-index">v</span> in connection with the provision of the Services. Pair has executed appropriate contracts with the service providers that prohibit them from using or sharing Personal Information except as necessary to perform the contracted services on our behalf or to comply with applicable legal requirements</p>
				</div>

				<h5 className="legal">Information Shared with Business Partners</h5>
				<div>
				...
				<h5 className="legal">Information Shared for Marketing</h5>
				<div>
				...
				<h5 className="legal">Information Shared with Third Parties</h5>
				<div>
				...
				<h5 className="legal">Information Disclosed in Connection with Business Transactions</h5>
				<div>
				...
				<h5 className="legal">Information Disclosed for Our Protection and the Protection of Others</h5>
				<div>
					<p>It is our policy to protect you from having your privacy violated through abuse of the legal system, whether by individuals, entities or government, and to contest claims that we believe to be invalid under applicable law. However, it is also our policy to cooperate with government and law enforcement ofﬁcials and private parties. Accordingly, we reserve the right to disclose any information about you to government or law enforcement ofﬁcials or private parties as we, in our sole discretion, believe necessary: <span className="roman-index">i</span> to satisfy or comply with any applicable law, regulation or legal process or to respond to lawful requests, including subpoenas, warrants or court orders; <span className="roman-index">ii</span> to protect our property, rights and safety and the rights, property and safety of third parties or the public in general; and <span className="roman-index">iii</span> to prevent or stop activity we consider to be illegal or unethical.</p>
				...
				<h5 className="legal">Information We Disclose With Your Consent or at Your Request</h5>
				<div>
				...
				<h5 className="legal">Information Displayed to Others Upon Posting of User Content</h5>
				<div>
				...
				<h5 className="legal">The Security of Your Information</h5>
				<div>
				...
				<h5 className="legal">Links to Other Sites</h5>
				<div>
				...
				<h5 className="legal">Modifying Your Information – rights of access, rectification, erasure, and restriction</h5>
				<div>
				...
				<h5 className="legal">Opt-out (Right to Object to Processing)</h5>
				<div>
				...
				<h5 className="legal">International Data Transfers</h5>
				<div>
				...
				<h5 className="legal">International Users</h5>
				<div>
				...
				<h5 className="legal">Data Retention</h5>
				<div>
				...
				<h5 className="legal">How Long We Keep Information</h5>
				<div>
				...
				<h5 className="legal">Our Policy Toward Children</h5>
				<div>
				...
				<h5 className="legal">Changes to Privacy Policy</h5>
				<div>
				...
				<h5 className="legal">California Privacy Rights</h5>
				<div>
				...
				<h5 className="legal">EU-U.S. Privacy Shield and Swiss-U.S. Privacy Shield</h5>
				<div>
				...
				<h5 className="legal">Definitions</h5>
				<div>
