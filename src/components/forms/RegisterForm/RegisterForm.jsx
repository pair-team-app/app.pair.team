			...
			<div className="register-form-wrapper">
				...
				<form onSubmit={this.handleSubmit}>
					...
					<Row vertical="center">
						...
						<button className="long-button aux-button adjacent-button" onClick={(event)=> { event.preventDefault(); trackEvent('button', 'github'); this.props.onPage('/modal/github-connect'); }}>Register via GitHub</button>
						<div className="page-link page-link-form" onClick={()=> { trackEvent('link', 'login'); this.props.onPage('/modal/login'); }}>Want to Login?</div>
					</Row>
				</form>
			</div>
		);
