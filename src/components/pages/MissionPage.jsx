			...
			<div className="mission-page-wrapper">
				<Row vertical="start">
					<Column flexGrow={1} horizontal="center">
						<Row horizontal="center"><div className="page-header-text">Our Design AI<br />Manifesto</div></Row>
						<div>
							...
							<Row><img src="/images/manifesto.png" className="mission-image" alt="Manifesto Garage" /></Row>
