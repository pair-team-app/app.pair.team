...
// 	console.log('IntegrationGridItem()', props);
	...
	const { title, image, selected, inheritedClass, onClick } = props;
	return (<div className={`integration-grid-item${(selected) ? ' integration-grid-item-selected' : ''}${(inheritedClass) ? Strings.lPad(inheritedClass, ' ', -1) : ''}`} onClick={()=> (onClick) ? props.onClick() : null}>
