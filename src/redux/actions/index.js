...
import { BUILD_PLAYGROUNDS_LOADED, INVITE_LOADED, INVITE_MODIFIED, COMMENT_ADDED, COMMENT_UPDATED, COMPONENT_TYPES_LOADED, DEVICES_LOADED, PRODUCTS_LOADED, SET_COMMENT, SET_COMPONENT, SET_INVITE, SET_PLAYGROUND, SET_ROUTE_PATH, SET_TEAM, SET_TYPE_GROUP, TEAM_BUILDS_LOADED, TEAM_COMMENTS_LOADED, TEAMS_LOADED, TEAM_LOGO_LOADED, TEAM_RULES_UPDATED, TEAM_UPDATED, TOGGLE_THEME, UPDATE_MOUSE_COORDS, UPDATE_RESIZE_BOUNDS, USER_PROFILE_ERROR, USER_PROFILE_LOADED, USER_PROFILE_UPDATED, TEAM_CREATED, TOGGLE_CREATE_TEAM, STRIPE_SESSION_CREATED, STRIPE_SESSION_PAID } from '../../consts/action-types';
...
export function toggleCreateTeam(payload) {
  logFormat('toggleCreateTeam()', null, payload);
  const createTeam = payload;
  return { payload : createTeam, type : TOGGLE_CREATE_TEAM };
}
