	...
	return (
		<BasePage className="privacy-page-wrapper">
			...
			<div className="privacy-page-text">
				...
				<div>
					<p>When you use the Services, we share certain information about you with other Service users.
						<ul>
							...
							<li><h6>Managed accounts and administrators</h6> If you register or access the Services using an email address with a domain that is owned by your employer or organization, or associate that email address with your existing account and such organization wishes to establish a Pair services account, certain information about you including your name, profile picture, contact info, content, and account use may become accessible to that organization’s administrator and other Pair service users, as permitted by your administrator, to provide you additional products and services or to integrate with Pair or other products and services. For example, your organization may request that we provide extra security controls around your account to protect information about your organization or your organization may request that we link your Pair account with your organization’s account to enhance collaboration and functionality among tools you use. If you are the administrator of a team, organization or enterprise account within the Services, we may share your contact information with current or past Service users, for the purpose of facilitating Service-related requests. </li>
						</ul>
					</p>
				</div>
				...
				<div>
					<p>We may share Personal Information with our business partners, and affiliates for our and our affiliates’ internal business purposes or to provide you with a product or service that you have requested. We may also provide Personal Information to business partners with whom we may jointly offer products or services, or whose products or services we believe may be of interest to you. In such cases, our business partner’s name will appear, along with Pair’s. Pair requires our affiliates and business partners to agree in writing to maintain the confidentiality and security of Personal Information they maintain on our behalf and not to use it for any purpose other than the purpose for which we provided them.</p>
				</div>
				...
				<h5>Definitions</h5>
				<div>
					<p>The following capitalized terms shall have the meanings herein as set forth below.
						<ul>
